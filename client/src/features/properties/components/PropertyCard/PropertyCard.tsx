...
import { MapPin, BedDouble, Bath, Maximize2, Sparkles } from 'lucide-react';
...
export const PropertyCard: React.FC<PropertyCardProps> = ({ property }) => {
  ...
  return (
    <article className={styles.card}>
      <Link to={`/propiedad/${property.id}`} className={styles.imageLink}>
      ...
      <div className={styles.content}>
        ...
        <Link to={`/propiedad/${property.id}`} className={styles.titleLink}>
